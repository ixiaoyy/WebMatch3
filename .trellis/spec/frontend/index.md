...
| [Ambient Fish Engine Contract](./game-engine-contract.md) | Authored waves, Fibonacci goals, tray clears, refresh, progression, and loss restart | Active |
...
- Read [Ambient Fish Engine Contract](./game-engine-contract.md) before changing wave generation, level goals, tray clears, refresh, progression, loss restart, or UI-facing transitions.
